...
In this document we take a look at the Seoul Biking Data (https://archive.ics.uci.edu/dataset/560/seoul+bike+sharing+demand). See the [data license file](./data_license.md) for more information about the data.
